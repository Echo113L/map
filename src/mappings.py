...
# ============================================================
# China province name → pyecharts China map standard name
# pyecharts China map uses names WITHOUT suffixes (省/市/自治区/特别行政区)
# ============================================================

# Standard pyecharts China province names (bare names)
...
# Variant → Standard for Chinese provinces
# Covers: full names with suffix, foreign names, abbreviations, pinyin
CN_PROVINCE_MAP = {
    # ── Municipalities (直辖市) ──
    "北京市": "北京", "北京": "北京",
    ...
    "Heilongjiang": "黑龙江",
    "江苏省": "江苏", "江苏": "江苏",
    "Jiangsu": "江苏", "Kiangsu": "江苏",
    "浙江省": "浙江", "浙江": "浙江",
    "Zhejiang": "浙江", "Chekiang": "浙江",
    "安徽省": "安徽", "安徽": "安徽",
    "Anhui": "安徽", "Anhwei": "安徽",
    "福建省": "福建", "福建": "福建",
    "Fujian": "福建", "Fukien": "福建",
    "江西省": "江西", "江西": "江西",
    "Jiangxi": "江西", "Kiangsi": "江西",
    "山东省": "山东", "山东": "山东",
    "Shandong": "山东", "Shantung": "山东",
    "河南省": "河南", "河南": "河南",
    "Henan": "河南", "Honan": "河南",
    "湖北省": "湖北", "湖北": "湖北",
    "Hubei": "湖北", "Hupeh": "湖北",
    ...
    "Hainan": "海南",
    "四川省": "四川", "四川": "四川",
    "Sichuan": "四川", "Szechuan": "四川", "Szechwan": "四川",
    "贵州省": "贵州", "贵州": "贵州",
    "Guizhou": "贵州", "Kweichow": "贵州",
    "云南省": "云南", "云南": "云南",
    "Yunnan": "云南",
    "陕西省": "陕西", "陕西": "陕西",
    "Shaanxi": "陕西", "Shensi": "陕西",
    "甘肃省": "甘肃", "甘肃": "甘肃",
    "Gansu": "甘肃", "Kansu": "甘肃",
    "青海省": "青海", "青海": "青海",
    "Qinghai": "青海", "Tsinghai": "青海",

    # ── Autonomous Regions (自治区) ──
    "内蒙古自治区": "内蒙古", "内蒙古": "内蒙古",
    "Inner Mongolia": "内蒙古", "Nei Mongol": "内蒙古",
    "广西壮族自治区": "广西", "广西": "广西",
    "Guangxi": "广西", "Kwangsi": "广西",
    "西藏自治区": "西藏", "西藏": "西藏",
    "Tibet": "西藏", "Xizang": "西藏",
    "宁夏回族自治区": "宁夏", "宁夏": "宁夏",
    "Ningxia": "宁夏", "Ningsia": "宁夏",
    "新疆维吾尔自治区": "新疆", "新疆": "新疆",
    "Xinjiang": "新疆", "Sinkiang": "新疆",
...
CN_TO_EN_COUNTRY = {
    ...
    "卢旺达": "Rwanda",
    "布隆迪": "Burundi",
    "刚果民主共和国": "Democratic Republic of the Congo", "刚果（金）": "Democratic Republic of the Congo", "刚果(金)": "Democratic Republic of the Congo",
...
MAPTYPE_NAMES = {
    "china": "china",
    "world": "world",
    # Individual countries - pyecharts supports many country-level maps
